...
Route::group(['prefix' => '/survey'], function (){
    Route::get('/', 'SurveyController@index')->name('index_survey')->middleware('auth');
    Route::get('/show/{id}', 'SurveyController@show')->name('show_survey')->middleware('auth');
    Route::get('/create', 'SurveyController@create')->name('create_survey')->middleware('auth');
    ...
    Route::post('/show/{id}/answered', 'ResponsesSurveyController@addResponse')->name('answered_survey')->middleware('auth');


    //Route::get('sondages', 'SurveysController@index');
    //Route::get('sondages/{sondage}', 'SurveysController@show');
    //Route::get('sondages-create', 'SurveysController@create');
    //Route::post('sondages', 'SurveysController@store');
    //Route::get('/sondages/{id}/edit', 'SurveysController@edit');
    //Route::patch('/sondages/{id}', 'SurveysController@update');
    //Route::delete('/sondages/{id}', 'SurveysController@delete');
